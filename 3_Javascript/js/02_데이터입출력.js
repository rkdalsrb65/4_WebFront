...
function getInnerHTML1(){
    ...
    // 브라우저 콘솔에 출력
    console.log(t1.innerHTML); // 자바의 print(); 역할
}
...
function getInnerText1(){
    ...
    // 브라우저 콘솔에 출력
    console.log(t2.innerText); // 자바의 print(); 역할
    console.log(t2.innerHTML); // 자바의 print(); 역할
}
...
function fnConfirm(){
    ...
    if(confirm("배경색을 분홍색으로 바꾸시겠습니까?")){ //확인
        ...
        document.getElementById("confirmTest").style.background = "gray";
    }
}
